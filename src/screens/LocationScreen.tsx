...
export const LocationScreen: React.FC = () => {
  ...
  const handleBackPress = () => {
    // Comportamento idêntico: aviso ao voltar
    setStateDropdownOpen(false);
    // Aqui poderíamos exibir um modal como nas outras telas;
    // para manter "nenhum outro componente alterado", seguimos fluxo simples.
    navigation.navigate('Login');
  };

  const handleNextPress = () => {
    // Navega para etapa de Segurança mantendo padrão do fluxo
    navigation.navigate('Security' as any);
  };
