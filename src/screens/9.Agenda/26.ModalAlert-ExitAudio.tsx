...
const ModalAlertExitAudio: React.FC<Props> = ({ visible, onCancel, onConfirm, itemLabel = 'Anotação' }) => {
  return (
      ...
      <View style={styles.overlay}>
        <View style={styles.card}>
          ...
          <View style={styles.textBox}>
            ...
            <Text style={styles.subtitle}>Ao sair, seu áudio ({itemLabel}) não será salvo. Confirmar saída?</Text>
          </View>
...
export default ModalAlertExitAudio;
