...
// Mantemos somente dependências necessárias para o fluxo simplificado
...
export const EmailValidationScreen: React.FC = () => {
  ...
  // Título fixo: fluxo simplificado mantém "Email"
  ...
  const handleNextPress = () => {
    // Próxima etapa do fluxo de troca de senha: Segurança
    navigation.navigate('ChangePasswordSecurity');
  };
  ...
  const renderProgressBar = () => {
    // Fluxo simplificado: exatamente 3 etapas
    const steps = 3;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        />
        <SecurityIcon />
        <Text style={styles.title}>Validação Email</Text>
        {renderProgressBar()}
      </View>
