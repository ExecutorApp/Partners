...
export const LoginScreen: React.FC<LoginScreenProps> = () => {
  ...
  const handleLogin = () => {
    if (validateForm()) {
      // Simular login bem-sucedido - conforme PRD, deve levar para seleção de empresa
      Alert.alert('Sucesso', 'Login realizado com sucesso! Redirecionando para seleção de empresa...');
      // TODO: navigation.navigate(ScreenNames.CompanySelection);
    }
  };
  ...
  const handleForgotPassword = () => {
    Alert.alert('Esqueci Senha', 'Redirecionando para recuperação de senha...');
    // TODO: navigation.navigate(ScreenNames.ForgotPassword);
  };
