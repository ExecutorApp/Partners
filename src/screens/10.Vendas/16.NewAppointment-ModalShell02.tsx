...
import NewSaleFeeDetails from './9.NewSale-FeeDetails';
import DateTimeScreen from './12.NewAppointment-PaymentChecklist';
import NewSaleDiscount from './10.NewSale-Discount';
...
const ModalShell: React.FC<ModalShellProps> = ({
  ...
  }, [currentStep, goToStep, maxAccessibleStep, onClose, onSchedule, onSelectAgendaType, onSelectStep, onUpdateSummary, selectedAgendaType, setTransitionDirection, summaries, transitionDirection, registerNextHandler, onCanProceedChange, visible]);
        ...
        <View style={styles.overlay}>
          <View style={styles.modalContainer}>
            ...
            <View style={styles.headerRow}>
              <Text style={styles.headerTitle}>{editing ? 'Editar Agendamento' : 'Nova venda'}</Text>
          ...
          {discountVisible && (
            <View style={styles.discountOverlay} pointerEvents="box-none">
              <View style={styles.discountPanelWrap}>
                <NewSaleDiscount summaries={summaries} onApply={() => setDiscountVisible(false)} onClose={() => setDiscountVisible(false)} />
              </View>
              <TouchableOpacity style={styles.discountBackdrop} onPress={() => setDiscountVisible(false)} accessibilityRole="button" accessibilityLabel="Fechar desconto" />
            </View>
          )}
        </View>
      </Modal>
